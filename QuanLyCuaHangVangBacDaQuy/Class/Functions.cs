...
namespace QuanLyCuaHangVangBacDaQuy.Class
{
    class Functions
    {
        ...
        {
            string path = Application.StartupPath + @"\VangBacDaQuy.mdf";
            Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=" + path + ";Integrated Security=True");
